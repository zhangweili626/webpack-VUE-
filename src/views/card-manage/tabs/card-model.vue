                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="前缀*" label-text-align="right" :label-cols="4">
                            <b-form-input :disabled="disabled || cardTemplateStatusFlag" :state="state.cardPrefix" v-model="param.cardPrefix"/>
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-6 col-lg-6">
    ...
    export default {
        ...
        methods: {
            ...
            publish(){
                ...
                if(_this.cardTemplateStatus == 0){
                    ...
                    _this.param.cardTemplateStatus = 2
            ...
            preserve(){
                ...
                }else if(escape(_this.param.cardPrefix).indexOf("%u")>0){
                    _this.state.cardPrefix = 'invalid'
                }
        ...
        created(){
            ...
            api.carTemlate.getCardTemplateInfoByCode({
                cardTemplateCode: _this.$route.params.code               
            },(msg)=>{
                if(msg.data.message == 'success'){
