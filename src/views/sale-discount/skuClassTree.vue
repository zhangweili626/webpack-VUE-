    ...
    <div class="row" @click="boxClick"> 
        <div class="col-md-12" @click="orgClick" >
                ...
                <div class="text-left salce-discount-skutree" v-show="orgShow">
                    <el-tree  show-checkbox :data="orgTreeData" :props="orgOptions" :load="goryLoad" node-key="categoryCode" lazy accordion check-strictly :default-expanded-keys="['000001']" :expand-on-click-node="false" ref="skuClassTree">
                    </el-tree>
                </div>
...
//          },          
    ...
    methods: {
        ...
        goryLoad(node, resolve) {
                ...
                api.skuComb.getSkuCategoryInfoBycategoryCode(params,(res) => {
        ...
        sureData() {
            let data = this.$refs.skuClassTree.getCheckedNodes();
            if(data.length != 0) {
                let nameStr = '';
        ...
        clear() {
            this.dataName = '';
            this.$refs.skuClassTree.setCheckedKeys([]);
        },
    },
    watch: {       
        orgShow(val) {
