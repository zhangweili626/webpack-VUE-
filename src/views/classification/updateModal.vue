<template>
    <b-modal id="update" ref="update" title="编辑服务分类" size="lg" @ok="handleOk" ok-title="确定" close-title="取消">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <b-form-fieldset horizontal label="服务分类编码" :label-cols="4" class="text-right">
                    <b-form-input v-model="insertParams.categoryCode" readonly/>
                </b-form-fieldset>
                <b-form-fieldset horizontal label="服务分类名称" :label-cols="4" class="text-right">
                    <b-form-input v-model="insertParams.categoryName" />
                </b-form-fieldset>
                <b-form-fieldset horizontal label="父级服务分类编码" :label-cols="4" class="text-right">
        ...
        loadNode(node, resolve) {
            if (node.level === 0) {
                let params = { categoryCode: config.serviceCategory.rootCode  };
                 api.serviceCategory.getService(params).then(res => {
