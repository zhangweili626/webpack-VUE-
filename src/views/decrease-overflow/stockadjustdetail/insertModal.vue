<template>
    <b-modal id="insert" ref="insert" title="新增报损报溢明细" size="lg" @ok="handleOk" ok-title="确定" @shown="showmodal" cancel-title="取消">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
    ...
    methods: {
        ...
        handleOk(evt) {
            ...
            api.ordinalInfo.getSequence({
                serviceCode: config.adjust.adjustDetailSEQ                    
            },(msg)=>{
                if(msg.data.message == "success"){
                    _this.param.adjustDetailCode = msg.data.obj
