<template>
    <div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        ...
                        <b-button size="sm" :disabled="createdAdjustStatus" variant="primary" @click.Enter="createdAdjust()">创建</b-button>                        
                    </div>
                </div>
            </div>           
        </b-card>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="pull-right">
                        ...
                        <!-- <b-button size="sm" variant="primary" @click="queryAdjustDetail">查询</b-button>                     -->
                    </div>
                </div>
            </div>
        ...
        <insertModal :whCode="params.whCode"  ref="insert" :calCostType="calCostType" :adjustNo="params.adjustNo" @handle-ok="handleOk"></insertModal>
        <upDataModal :whCode="params.whCode"  ref="updata" :calCostType="calCostType" :adjustDetail="adjustDetail" @handle-ok="handleOk"></upDataModal>
    </div>
</template>
<script>
    import Vue from "vue";
    ...
    export default {
        ...
        methods: {
            ...
            createdAdjust(){
                ...
                if(!_this.params.whCode){
                    ...
                    api.adjust.addAdjust(_this.params,(msg)=>{
                                if(msg.data.message == 'success'){
                                    ...
                                    api.adjust.queryAdjust({
                                        ...
                                        if(msg.data.message == 'success'){
                                            _this.oldAdjustData  = msg.data.obj.list[0]
        ...
        created() {
            ...
            api.ordinalInfo.getSequence({
                serviceCode: config.adjust.adjustSEQ                    
            },(msg)=>{
                if(msg.data.message == "success"){
                    _this.params.adjustNo = msg.data.obj
