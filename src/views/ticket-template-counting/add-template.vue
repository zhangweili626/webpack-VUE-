    ...
    <div class="car-template card">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="模板名称*" label-text-align="right" :label-cols="4">
                            <b-form-input :state="state.couponTemplateName" v-model="param.couponTemplateName" />
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="类型" label-text-align="right" :label-cols="4">
                            <b-form-select :disabled="true" v-model="param.couponTypeCode" :options="userTypeList"/>
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="前缀*" label-text-align="right" :label-cols="4">
                            <b-form-input placeholder="请填写字母区分大小写" :state="state.couponPrefix" v-model="param.couponPrefix" @input="couponPrefixChange()" />
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="时间戳" label-text-align="right" :label-cols="4">
                            <b-form-select v-model="param.hasTimestamp" @input="changehasTimestamp" :options="hasTimestampList" />
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="格式" label-text-align="right" :label-cols="4">
                            <b-form-select :state="state.timestampFormat" :disabled="param.hasTimestamp == 0" v-model="param.timestampFormat" :options="timestampFormatList" />
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-12 col-lg-12">
                        <b-form-fieldset horizontal label="描述" label-text-align="right" :label-cols="2">
                            <b-form-textarea id="textarea1" v-model="param.couponDescription" :rows="3" @input="strLenght(1)" :max-rows="6">
                            </b-form-textarea>
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-12 col-lg-12">
                        <b-form-fieldset horizontal label="备注" label-text-align="right" :label-cols="2">
                            <b-form-textarea id="textarea2" v-model="param.remark" :rows="3" @input="strLenght(2)" :max-rows="6">
                            </b-form-textarea>
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-12 col-lg-12">
                        <b-form-fieldset horizontal label="免责条款" label-text-align="right" :label-cols="2">
                            <b-form-textarea id="textarea2" v-model="param.couponRules" @input="strLenght(3)" :rows="3" :max-rows="6">
                            </b-form-textarea>
                        </b-form-fieldset>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="制券申请方*" label-text-align="right" :label-cols="4">
                            <org-tree @getOrgCode="getOrg" :class="{'inp-invalid' : state.applyOrgCode}" :params='{code:param.applyOrgCode,orgName:param.applyOrgName}'></org-tree>
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="申请人" label-text-align="right" :label-cols="4">
                            <b-form-input v-model="param.applyEmpName" />
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="使用方*" label-text-align="right" :label-cols="4">
                            <b-form-select :state="state.couponUseTypeCode" v-model="param.couponUseTypeCode" :options="cardUseTypeList" />
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="使用性质*" label-text-align="right" :label-cols="4">
                            <b-form-select :state="state.useNatureTypeCode" v-model="param.useNatureTypeCode" :options="useNatureTypeList" />
                        </b-form-fieldset>
                    </div>
                </div>
                <div class="staticTime">
                    <b-form-fieldset horizontal label="有效期类型*" label-text-align="right" :label-cols="2">
                        <b-container fluid>
                            <b-row class="my-1">
                                <b-col sm="5">
                                    <input @change="couponExpireTypeChange()" :class="{'inp-invalid' : state.couponExpireType}" type="radio" name="time" value="0" v-model="param.couponExpireType" disabled>&nbsp;&nbsp;固定时长
                                </b-col>
                                <b-col sm="7">
                                    <div class="row">
                                        <div class="col-md-10">
                                            <b-form-input :disabled="param.couponExpireType==1" :state="state.expirePeriod" v-model="param.expirePeriod" type="number" />
                                        </div>
                                        <div class="pt-1">
                                            天
                                        </div>
                            ...
                            <b-row class="my-1">
                                <b-col sm="5">
                                    <input @change="couponExpireTypeChange()" :class="{'inp-invalid' : state.couponExpireType}" type="radio" name="time" value="1" v-model="param.couponExpireType">&nbsp;&nbsp;有效期限
                                </b-col>
                                <b-col sm="7">
                                     <el-date-picker :disabled="param.couponExpireType==0"  :class="{'inp-invalid' : state.expireDate}" v-model="param.expireDate" type="daterange" placeholder="选择日期" :picker-options="pickerOptions1">
                                    </el-date-picker>
                                </b-col>
                            </b-row>
                        </b-container>
                ...
                <div class="pictureStyle">
                    <b-form-fieldset label="图样：" label-text-align="left" :label-cols="2">
                        <div class="needUpload row">
                            <upload :on-success="fronthandleSuccess" :on-error="onError" :file-list="frontfileList" :parame="frontuploadParams" :on-remove="fronthandleRemove" :title="'正面'"></upload>
                            <upload :on-success="reversehandleSuccess" :on-error="onError" :file-list="reversefileList" :parame="reverseuploadParams" :on-remove="reversehandleRemove" :title="'反面'"></upload>
                            <upload :on-success="brand1handleSuccess" :on-error="onError" :file-list="brand1fileList" :parame="brand1uploadParams" :on-remove="brand1handleRemove" :title="'宣传页'"></upload>
                            <upload :on-success="brand2handleSuccess" :on-error="onError" :file-list="brand2fileList" :parame="brand2uploadParams" :on-remove="brand2handleRemove" :title="'宣传页'"></upload>
                            <upload :on-success="brand3handleSuccess" :on-error="onError" :file-list="brand3fileList" :parame="brand3uploadParams" :on-remove="brand3handleRemove" :title="'宣传页'"></upload>
                        </div>
        ...
        <div class="row ml-2 mr-2 mb-2">
            <div class="col-md-12">
                <div class="pull-right">
                    ...
                    <b-button :disabled="!detailShow" size="sm" variant="primary" @click="publish">发布</b-button>
                </div>
            </div>
        </div>
        <div class="specialTabs" v-if="detailShow">
            <b-tabs>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-12">
                            <div class="pull-left">
                                ...
                                <b-button size="sm" variant="success" :disabled="!!containerlist.length" @click="addContainer">添加</b-button>
                            </div>
                            <!-- <div class="pull-right"> -->
                                <!-- <b-button size="sm" variant="success" @click="submitdetail">保存</b-button> -->
                            <!-- </div> -->
                        </div>
                    </div>
                ...
                <b-tab title="使用范围">
                    <scope ref="scope" :additionalSelect="additionalSelect" :multipleSelection="true" :fields="fields" @deletScopeBtn="deletScopeBtn" :addscope="addscope" :tablist="scopeList"></scope>
                </b-tab>
                <b-tab title="售价设定">
                    <pricesetting ref="scope1" :additionalSelect="additionalSelectprice" :multipleSelection="true" :fields="pricesettingfields" @deletScopeBtn="pricesettingdeletScopeBtn" :addscope="addpricesetting" :tablist="pricesettingscopeList"></pricesetting>
                </b-tab>
            </b-tabs>
        </div>
        <model ref="myModalRef" @query="queryCouponTemplateDetailInfoNoPage" :couponTemplateCode="param.couponTemplateCode"/>
    </div>
</template>
<script>
import Vue from 'vue'
...
export default {
    ...
    methods: {
        ...
        publish() {
            const _this = this;
            if ((_this.containerlist.length == 0) || (_this.scopeList.length == 0)||(_this.pricesettingscopeList.length == 0)) {
                Message({
                    type: 'warning',
                    message: '未填写模板内容/使用范围/售价设定！'
                });
                return;
            }
            let param = {
            ...
            api.ticketTemlate.releaseCouponTemplateInfo(param, (msg) => {
        ...
        fronthandleSuccess(res) {
            ...
            if (data.message == 'success') {
                ...
                _this.param.couponPic1 = file.filePath
        ...
        reversehandleSuccess(file) {
            ...
            if (data.message == 'success') {
                ...
                file.name = '反面'
                file.url = common.getUploadUrl() + file.filePath
                _this.param.couponPic2 = file.filePath
        ...
        brand1handleSuccess(file) {
            ...
            if (data.message == 'success') {
                ...
                file.name = '宣传页'
                file.url = common.getUploadUrl() + file.filePath
                _this.param.couponPic3 = file.filePath
        ...
        brand2handleSuccess(file) {
            ...
            if (data.message == 'success') {
                ...
                file.name = '宣传页'
                file.url = common.getUploadUrl() + file.filePath
                _this.param.couponPic4 = file.filePath
        ...
        brand3handleSuccess(file) {
            ...
            if (data.message == 'success') {
                ...
                file.name = '宣传页'
                file.url = common.getUploadUrl() + file.filePath
                _this.param.couponPic5 = file.filePath
        ...
        preserve() {
            ...
            if (!_this.param.couponTemplateName) {
            ...
            if (_this.param.couponExpireType == 0) {
                ...
                _this.param.expirePeriod = ''
                if (_this.param.expireDate.length == 0) {
                    _this.state.expireDate = 'invalid'
                    _this.state.expirePeriod = null
                }
            }
            if (!(_this.param.expireDate.length == 0)) {
                _this.param.startDate = common.formattingTime(this.param.expireDate).startTime
                _this.param.endDate = common.formattingTime(this.param.expireDate).endTime
            }
            // || _this.param.couponAmout < 0
            if (!_this.param.couponTemplateName  || !_this.param.couponPrefix || !(/^[A-Za-z]+$/.test(_this.param.couponPrefix)) || !_this.param.applyOrgCode || !_this.param.couponUseTypeCode || !_this.param.useNatureTypeCode || ((_this.param.couponExpireType != 0) && (_this.param.couponExpireType != 1)) || ((_this.param.expirePeriod <= 0 || !Number.isInteger(parseFloat(_this.param.expirePeriod))) && _this.param.expireDate.length == 0)) {
                return;
            }
            if (_this.param.hasTimestamp == 1) {
                if (!_this.param.timestampFormat) {
    ...
    created() {
        ...
        api.ordinalInfo.getSequence({
            serviceCode: 'COUPONTEMPLATESEQ'
        }, (msg) => {
            if (msg.data.message == 'success') {
                _this.param.couponTemplateCode = msg.data.obj
                _this.frontuploadParams.relationCode = msg.data.obj
                _this.reverseuploadParams.relationCode = msg.data.obj
                _this.brand1uploadParams.relationCode = msg.data.obj
                _this.brand2uploadParams.relationCode = msg.data.obj
                _this.brand3uploadParams.relationCode = msg.data.obj
