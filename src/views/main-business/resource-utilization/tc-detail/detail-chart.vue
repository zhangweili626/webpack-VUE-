...
<div class="dc-container clearfix" >
    ...
    <div class="wrapper" style="width: 100%">
        <div class="dc-content pull-left" :style="{width: contentWidth + 'px', marginLeft: leftWidth + 'px',overflow:'hidden'}">
    ...
    <div class="wrapper" style="width: 100%" v-if="!timeList.length">
...
export default {
    ...
    computed: {
        ...
        detailInfo() {
            ...
            let    _disparit = this.getWidth(item.actualStartTime, item.estimateStartTime)
                // ( 预计开始时间 - 看板开始时间 ) * 每分钟的宽度
            let    _left = this.getWidth(item.estimateStartTime, this.defaultStartTime)
                // 判断技师是否打卡, 以及关卡
            let _dw   = item.actualStartTime 
                            ? item.actualEndTime 
