...
<script>
    ...
    export default {
        ...
        methods: {
            pageChange(v){
                const _this = this;
                _this.query(v,_this.checkRowData.cardMakeOrderNo)
            },
            // 查询总量
            queryTotal(cardMakeOrderNo) {
                const _this = this
                let option = {
                    cardTemplateCode: _this.$route.query.cardTemplateCode,
                    cardMakeOrderNo: cardMakeOrderNo
                }
            ...
            showDetail(data) {
                ...
                _this.query(1,_this.checkRowData.cardMakeOrderNo)
                _this.queryTotal(_this.checkRowData.cardMakeOrderNo)
                _this.$refs.modal.show()
            },
            query(arg,cardMakeOrderNo){
                const _this = this
                let option = {
                    cardTemplateCode: _this.$route.query.cardTemplateCode,
                    cardMakeOrderNo: cardMakeOrderNo,
