                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="模板名称*" label-text-align="right" :label-cols="4">
                            <b-form-input :state="state.cardTemplateName" v-model="param.cardTemplateName"/>
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="面值(元)*" label-text-align="right" :label-cols="4">
                            <div class="row">
                                <div class="col-md-10">
                                    <b-form-input type="number" :state="state.cardAmout" v-model="param.cardAmout" min="0" /> 
                                </div>
                                <div class="pt-1">
                                    元
                                </div>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="前缀*" label-text-align="right" :label-cols="4">
                            <b-form-input :state="state.cardPrefix" v-model="param.cardPrefix" @input="cardPrefixChange()"/>
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-6 col-lg-6">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <b-form-fieldset horizontal label="使用方*" label-text-align="right" :label-cols="4">
                            <b-form-select :state="state.cardUseTypeCode" v-model="param.cardUseTypeCode" :options="cardUseTypeList"/>
                        </b-form-fieldset>
                    </div>
                    <div class="col-md-6 col-lg-6">
                ...
                <div class="staticTime">
                    <b-form-fieldset horizontal label="有效期类型*" label-text-align="right" :label-cols="2">
                            ...
                            <b-row class="my-1">
                                <b-col sm="5">
                                    <input @change="cardExpireTypeChange()" :class="{'inp-invalid' : state.cardExpireType}" type="radio" name="time" value="0" v-model="param.cardExpireType">&nbsp;&nbsp;固定时长
                                </b-col>
                                <b-col sm="7">
                                    <div class="row">
                                        <div class="col-md-10">
                                            <b-form-input :disabled="param.cardExpireType==1"  :state="state.expirePeriod" v-model="param.expirePeriod" type="number" />
                                        </div>
                                        <div class="pt-1">
                                            天
                                        </div>
                            ...
                            <b-row class="my-1">
                                <b-col sm="5">
                                    <input @change="cardExpireTypeChange()" :class="{'inp-invalid' : state.cardExpireType}" type="radio" name="time" value="1" v-model="param.cardExpireType">&nbsp;&nbsp;标定结束日期
                                </b-col>
                                <b-col sm="7">
                                    <el-date-picker
                                        :disabled="param.cardExpireType==0"
...
                            accept="image/png,image/gif,image/jpg,image/jpeg"                            
                            list-type="picture">
                            <b-button size="small" variant="success">正面</b-button>
                            </upload>
                        </div>
                        <div class="col-md-4 col-lg-4 mt-2">
                            <upload
...
                            accept="image/png,image/gif,image/jpg,image/jpeg"                            
                            list-type="picture">
                            <b-button size="small" variant="success">反面</b-button>
                            </upload>
                        </div>
                        <div class="col-md-4 col-lg-4 mt-2">
                            <upload
...
                            accept="image/png,image/gif,image/jpg,image/jpeg"                            
                            list-type="picture">
                            <b-button size="small" variant="success">宣传页</b-button>
                            </upload>
                        </div>
                        <div class="col-md-4 col-lg-4 mt-2">
                            <upload
        ...
        <div class="row ml-2 mr-2">
            <div class="col-md-12">
                <div class="pull-right">
                    <b-button size="sm" variant="primary" @click="preserve()">暂存</b-button> 
            ...
            <b-tabs>
                <b-tab title="内容">
                    <div class="row mb-2">
                        <div class="col-md-12">
                            <div class="pull-left">
                                <b-button size="sm" variant="success" @click="addContainer">新增</b-button>                                                        
                ...
                <b-tab title="使用范围">
                    <scope ref="scope" :additionalSelect="additionalSelect" :pageData="scopePageData" @page-change="queryCardTemplateUseRangeInfo" :multipleSelection="true" :fields="fields" @deletScopeBtn="deletScopeBtn"  :addscope="addscope" :tablist="scopeList"></scope>                    
                </b-tab>
            </b-tabs>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //查询适用范围
            queryCardTemplateUseRangeInfo(value=0){
                const _this = this;  
                api.carTemlate.queryCardTemplateUseRangeInfo({cardTemplateCode:_this.param.cardTemplateCode,pageStart:value,pageNums:config.pageNums},(msg)=>{
                    if(msg.data.message == 'success'){
            ...
            preserve(){
                ...
                if((_this.param.cardExpireType) != 0 || (_this.param.cardExpireType != 1)){
                ...
                if(_this.detailShow){
                    ...
                    api.carTemlate.insertCardTemplateInfo(_this.param,(msg)=>{
                        if(msg.data.message == 'success'){
        ...
        created(){
            ...
            api.ordinalInfo.getSequence({
                serviceCode: 'CARDTEMPLATESEQ'                    
            },(msg)=>{
                if(msg.data.message == 'success'){
                    _this.param.cardTemplateCode = msg.data.obj
