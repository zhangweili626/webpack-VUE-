    ...
    <div class="upload">
      <div class="upload_warp_img  clearfix">
        <!-- <div class="upload_warp_text"> -->
          <!-- 选中{{fileList.length}}张文件，共{{bytesToSize(this.size)}} -->
        <!-- </div> -->
        <div class="upload_warp_img_div" v-for="(item,index) of fileList" :key="index">
          ...
          <el-tooltip v-if="item.name" class="item" effect="dark" :content="item.name" placement="top-start">
        ...
        <div class="upload-footer text-center" v-show="isShowFoot">
            <span class="text-primary mr-2" @click="fileClick()" v-show="fileList.length == '0'">上传</span>
            <span class="text-danger" @click="fileDel(fileList[0])">删除</span>
          </div>
      </div>
