                        ...
                        <div class="border pt-3">
                            <div class="col-md-12 col-lg-12">
                                <b-form-fieldset horizontal label="销售区域" :label-cols="4" class="text-right">
                                    <!-- <el-select v-if="multipleSelection" size="large" @change="StoreModelChange" no-data-text="请选择区域" v-model="checkTreeList" multiple placeholder="请选择区域">
                                        <el-option
                                    ...
                                    <div class="text-left mt-2" v-if="multipleSelection">
                                        <el-tag
                                        class="ml-2 mb-2"                                        
...
export default {
    ...
    mounted(){
        ...
        if((JSON.stringify(_this.storeInfoVo) != "{}")){
            _this.storeList = [{text:_this.storeInfoVo.storeName,value:_this.storeInfoVo.storeCode}]
            _this.storeCheckList = [_this.storeInfoVo.storeCode]
            // _this.storeCode = _this.storeInfoVo.storeCode
            _this.checkTree.name = _this.storeInfoVo.salesName
            _this.checkTree.code = _this.storeInfoVo.salesCode
            _this.options = [{
