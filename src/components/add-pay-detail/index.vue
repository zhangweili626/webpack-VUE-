<template>
    <div>
         <el-dialog id="modalPay" title="收款人：" ref="modalPay" @open="reset" :visible.sync="dialogPay" :modal-append-to-body="false" style="max-width: 900px!important; left: 15%">
...
export default {
    ...
    props: {
        ...
        refCode: {           //卡充值： CARDRECHARGEPAYMENTSEQ， 劵销售：
                type: String,
                default: ''
        }
    },
